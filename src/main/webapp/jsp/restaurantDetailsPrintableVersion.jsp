...
<html lang="en" style="height:100%;">
  ...
  <body style="background-color:whitesmoke; background-color:whitesmoke; background-image: url('http://localhost:8080/FeedMe/images/knifeAndFruitesBoard.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    <!-- Main Div -->
    <div id="main">
       <!-- Title -->
