	  ...
	  <li>
	    <!-- Brings user to a printable version of the page -->
	      <form id="printableForm" action="/FeedMe/recipeDetailsPagePrintableVersion?arrNum=<%=arrNum%>" method= "POST">
	      	<button id="printButton" type="submit button" class="btn btn-primary linkToSite">Printable Version</button>
	      </form>
	  </li>
	  ...
	  <li>
	    <!-- Brings user back to results page -->
	       <form action="/FeedMe/results" method="POST">
	        <button id="backToResults" type="submit button" class="btn btn-primary linkToSite">Back To Results</button>
	      </form>
	  </li>
